 ...
 * Class Name: VTPassFailedRequestException.php
...
class VTPassFailedRequestException extends \Exception
{
    ...
    /**
     * @param int $code
     * @return VTPassFailedRequestException
     *
     * @link https://docs.teamapt.com/display/MON/Transaction+Responses
     */
    public static function byCode(int $code): VTPassFailedRequestException
    {
        switch ($code) {
            case 0:
